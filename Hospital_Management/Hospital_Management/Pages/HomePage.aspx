<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HomePage.aspx.cs" Inherits="Hospital_Management.Pages.HomePage" %>
			...
			<div class="container">
				<div class="row align-items-center">
					...
					<div class="col-lg-9 col-sm-6 col-8 header-top-right">
						...
						<a href="#appoinment_form" class="primary-btn text-uppercase">Appointment</a>
					</div>
				</div>
			</div>
		</div>
						...
						<ul class="nav navbar-nav menu_nav ml-auto">
							...
							<li class="nav-item submenu dropdown">
								...
								<ul class="dropdown-menu">
									...
									<li class="nav-item"><a class="nav-link" href="../UpdateInfo.aspx">Update</a></li>
					...
					<div class="single_feature">
						...
						<div class="feature_content">
							<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et
								dolore magna aliqua. Ut enim ad minim veniam.</p>
							<div class="feature_btn">
								<a href="#Doctor_Time_Table" class="f_btn">Learn More</a>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="single_feature">
						...
						<div class="feature_content">
							<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et
								dolore magna aliqua. Ut enim ad minim veniam.</p>
							<div class="feature_btn">
								<a href="#appoinment_form" class="f_btn">Get Appointment</a>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="row align-items-center">
				...
				<div class="col-lg-4 offset-lg-3 col-md-6 offset-md-1">
					<div class="about_right overlay">
						<div class="about_inner" id="Doctor_Time_Table">
...
<!--				 appoinment area -->
				<div class="col-lg-12 col-centered">
					<div class="recent_blog appoinment"  id="appoinment_form">
						<div class="blog_title">
