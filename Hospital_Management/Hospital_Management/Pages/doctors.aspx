<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Doctors.aspx.cs" Inherits="Hospital_Management.Pages.WebForm1" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent">
    <asp:Label ID="Label6" runat="server" Text="Label">Medicare Popular Doctors Information:</asp:Label>
    <asp:GridView ID="DoctorGridView" CssClass="col-lg-12 col-md-12 col-sm-12 col-xs-12"  runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCC" BorderStyle="None" BorderWidth="1px" CellPadding="3">
        <Columns>
            ...
            <asp:TemplateField HeaderText="Doctor Specialist">
                <EditItemTemplate>
                    <asp:TextBox ID="TextBox2" runat="server" Text='<%# Bind("Doctor_Specialist") %>'></asp:TextBox>
                </EditItemTemplate>
                <ItemTemplate>
