<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Medicine.aspx.cs" Inherits="Hospital_Management.Pages.Medicine" %>
...
<asp:Label ID="Label7" runat="server" Text="Label">Medicine Information :</asp:Label>
    ...
    <asp:GridView ID="MediceneGridView" CssClass="col-lg-12 col-md-12 col-sm-12 col-xs-12" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCC" BorderStyle="None" BorderWidth="1px" CellPadding="3">
        <Columns>
