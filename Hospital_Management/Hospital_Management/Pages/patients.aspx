<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Patients.aspx.cs" Inherits="Hospital_Management.Pages.patients" %>
    ...
    <asp:GridView ID="UserGridView" CssClass="col-lg-12 col-md-12 col-sm-12 col-xs-12" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCC" BorderStyle="None" BorderWidth="1px" CellPadding="3">
        <Columns>
            ...
            <asp:TemplateField HeaderText="Patient Mobile">
                <EditItemTemplate>
                    <asp:TextBox ID="TextBox3" runat="server" Text='<%# Bind("Patient_Mobile") %>'></asp:TextBox>
                </EditItemTemplate>
                <ItemTemplate>
            ...
            <asp:TemplateField HeaderText="Patient Address">
                <EditItemTemplate>
                    <asp:TextBox ID="TextBox4" runat="server" Text='<%# Bind("Patient_Address") %>'></asp:TextBox>
                </EditItemTemplate>
                <ItemTemplate>
                ...
                <HeaderStyle BackColor="#9e4fff" Font-Bold="True" ForeColor="White" />
